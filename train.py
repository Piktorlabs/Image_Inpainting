...
# print(args.root, args.mask_root)
...
dataset_val = Places2(args.root, args.mask_root, img_tf, mask_tf, 'test')
...
if args.resume:
    ...
    # args.max_iter = start_iter + 10000
    
    for param_group in optimizer.param_groups:
        param_group['lr'] = lr
    print('Starting from iter ', start_iter, "max iter", args.max_iter)
